...
// 個別のStatCardも提供
export const IncomeCard: Meta<typeof StatCard> = {
...
export const Income: StoryObj<typeof StatCard> = {
  args: {
    title: '今月の収入',
    value: '¥150,000',
    description: '3 件の収入',
...
export const Expense: StoryObj<typeof StatCard> = {
  args: {
    title: '今月の支出',
    value: '¥80,000',
    description: '12 件の支出',
...
export const Balance: StoryObj<typeof StatCard> = {
  args: {
    title: '今月の残高',
    value: '¥70,000',
    description: '黒字です',
    icon: <Wallet className="h-4 w-4 text-chart-2" />,

    ...
    <RadioGroup defaultValue="comfortable">
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="grid gap-1.5 leading-none">
          ...
          <p className="text-xs text-muted-foreground">More spacing for better readability.</p>
        </div>
      </div>
      <div className="flex items-center space-x-2">
        ...
        <div className="grid gap-1.5 leading-none">
          ...
          <p className="text-xs text-muted-foreground">Less spacing to fit more content.</p>
        </div>
      </div>
    </RadioGroup>
  ),
